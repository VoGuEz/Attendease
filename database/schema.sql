...
INSERT IGNORE INTO attendance (session_id, student_id, join_time, status) VALUES
  (3, 2, ADDTIME(DATE_SUB(NOW(), INTERVAL 1 DAY), '14:05:00'), 'PRESENT'),
  (3, 3, ADDTIME(DATE_SUB(NOW(), INTERVAL 1 DAY), '14:20:00'), 'LATE'),
  (3, 4, NULL, 'ABSENT'),
  (4, 2, ADDTIME(DATE_SUB(NOW(), INTERVAL 2 DAY), '10:03:00'), 'PRESENT'),
  (4, 3, ADDTIME(DATE_SUB(NOW(), INTERVAL 2 DAY), '10:08:00'), 'PRESENT'),
  (4, 4, ADDTIME(DATE_SUB(NOW(), INTERVAL 2 DAY), '10:01:00'), 'PRESENT');
